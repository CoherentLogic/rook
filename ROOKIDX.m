...
GETROWS(EGG,EMBRYO,VALUE,RESULT)
 ...
 . S CACHED=1
 . LOCK (^ROOK("SESSION",$J,"CACHEHITS")):30
 . I $TEST D
 . . S ^ROOK("SESSION",$J,"CACHEHITS")=$I(^ROOK("SESSION",$J,"CACHEHITS"))
 . LOCK
 E  D
 . S CACHED=0
 . LOCK (^ROOK("SESSION",$J,"CACHEMISSES")):30
 . I $TEST D
 . . S ^ROOK("SESSION",$J,"CACHEMISSES")=$I(^ROOK("SESSION",$J,"CACHEMISSES"))
 . LOCK
 G:CACHED=1 QCACHED
 ;
